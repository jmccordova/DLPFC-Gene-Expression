# Part 1: Setting up
  ...
  # Part 1.5: Extracting data
    ...
    # Part 1.5.5: Get unique gene IDs
    ...
    # Part 1.5.6: Retain only the genes which probeset ID are found in the DLPFC dataset
    ids.transcript <- ids.transcript[ids.transcript$id_internal_huex %in% unique(probeNames(rawData)), ]
    # Part 1.5.7: Combine the probeIDs from DLPFC dataset that have no gene IDs
